  ...
  return (
    <div className='flex flex-col w-full h-fit  pt-5 '  >
       ...
       <div  className=' grid md:grid-cols-[1fr_2fr] w-full gap-8 p-5 mt-10 h-fitcontactContainer   ' >
         <div  className=' flex flex-col h-fit rounded-2xl p-5 text-left gap-4  '  style={{ background:"rgb(18,18,18)", boxShadow:"0 0 10px rgba(255,255,255,0.345)" }} >
             ...
             <h1  className=' font-bold text-2xl sm:text-3xl md:text-3xl  lg:text-4xl ' style={{color:"rgb(0,255,0)"}} >Krishna Sharma</h1>
